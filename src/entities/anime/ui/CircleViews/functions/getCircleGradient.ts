...
const getCircleGradient = (props: ICircleViewsProps) => {
  ...
  return `conic-gradient(var(--bisky-400) ${stateArray[3]}deg, var(--green) ${stateArray[3]}deg ${stateArray[3] + stateArray[1]}deg, var(--bisky-200) ${stateArray[3] + stateArray[1]}deg ${stateArray[3] + stateArray[1] + stateArray[0]}deg, var(--blue) ${stateArray[3] + stateArray[1] + stateArray[0]}deg)`
}

...
import { IGetOneAnimeQLProps } from "./IGetOneAnimeQLProps"

const getOneAnimeQL = async (
  props: IGetOneAnimeQLProps,
): Promise<Partial<IAnimeFullModel>> => {
  const { animeId } = props
  ...
  const result = await fetch(API_URL + "/graphql", {
    ...
    body: JSON.stringify({
      ...
      `,
      variables: { animeQuery: { filter: { _id_ID: [animeId] } } },
    }),
